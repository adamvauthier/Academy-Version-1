...
function nelio_max_image_size( $file ) {
  ...
  if ( $is_image && $size > $limit || $is_pdf && $size > $limit2 ) {
    $file['error'] = 'The file you are trying to upload is too large. If you are working with an image, please try uploading it to Optimizilla.com and then downloading the optimized version of the file. If you are working with a PDF, please try uploading it to Smallpdf.com and then downloading the compressed version of the file. <br />If your file is still too large to upload to WordPress, send an email to hello@desalesmedia.org or call 718-424-6704, and we will be happy to help.' ;
  }//end if
